...
export default function Footer() {
  ...
  return (
    <footer className="section-accent border-t border-warm-300 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-xl font-bold mb-6 text-secondary-900">Services</h4>
          ...
          {/* Contact Info */}
          <div>
            <h4 className="text-xl font-bold mb-6 text-secondary-900">Contact</h4>
